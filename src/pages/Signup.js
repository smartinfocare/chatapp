...
export default class SignUp extends Component {
  ...
  //click the button for google signup
  async googleSignIn() {
    try {
  ...
  //click the button for github signup
  async githubSignIn() {
    try {
...
<p class="text-lead text-light">Fill in the form below to create an account.</p>
</div>
</div>
</div>
</div>
...
<div class="text-muted text-center mt-2 mb-3"><small>Create Account with</small></div>
